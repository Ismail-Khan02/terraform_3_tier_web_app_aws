...
resource "aws_cloudwatch_metric_alarm" "web_cpu_high" { 
  ...
  alarm_actions = [aws_autoscaling_policy.web_scale_up.arn, aws_sns_topic.alarm_topic.arn]
...
resource "aws_cloudwatch_metric_alarm" "web_cpu_low" { 
  ...
  alarm_actions = [aws_autoscaling_policy.web_scale_down.arn, aws_sns_topic.alarm_topic.arn]
...
resource "aws_cloudwatch_metric_alarm" "app_cpu_high" { 
  ...
  alarm_actions = [aws_autoscaling_policy.app_scale_up.arn, aws_sns_topic.alarm_topic.arn]
...
resource "aws_cloudwatch_metric_alarm" "app_cpu_low" { 
  ...
  alarm_actions = [aws_autoscaling_policy.app_scale_down.arn, aws_sns_topic.alarm_topic.arn]
